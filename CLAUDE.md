...
|---|---|---|---|
| 1 | 0.96" IPS colour LCD (AX22-0034) | SPI `MOSI=12`/`SCK=14`; CS = `P1_IO0=4`, DC = `P1_IO2=2`, RST = `P1_IO1=3` (✓ bring-up 2026-06-27) | **ST7735** `INITR_MINI160x80`, 80×160 native → **160×80 landscape at `setRotation(3)`**, `invertDisplay(false)`, MADCTL colour order **BGR** (Adafruit sets RGB for this tab → re-send after setRotation; red showed blue, 2026-09-23). Adafruit ST7735 lib. Severity colours: BGR fix 2026-09-23, device check pending. |
